...
const benefits = [
  {
    ...
    className:
      'md:col-span-2 md:row-span-2 bg-gradient-to-br from-slate-900 to-slate-950 border border-white/5',
  },
  {
    ...
    className:
      'md:col-span-1 bg-slate-900/50 border border-white/5',
  },
  {
  ...
  },
  {
    ...
    className:
      'md:col-span-2 bg-slate-900/50 border border-white/5 flex flex-row items-center gap-6',
    horizontal: true,
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-slate-400 text-lg md:text-xl max-w-2xl mx-auto">
            Hemos diseñado una herramienta que simplifica la
            administración sin quitarte tiempo valioso.
          </p>
        </motion.div>
        ...
        >
          {benefits.map((benefit, i) => (
            <motion.div
              ...
              className={`p-8 rounded-3xl flex ${
                benefit.horizontal
                  ? 'flex-row items-center'
                  : 'flex-col'
              } gap-6 transition-transform hover:-translate-y-1 hover:shadow-2xl hover:shadow-emerald-500/10 ${
                benefit.className
              }`}
            >
              {/* Icon */}
