import { BrainCircuit, Rocket, LockKeyhole } from "lucide-react";
      ...
      <div className="relative z-10 w-full max-w-lg">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="col-span-2 bg-card/60 border border-border backdrop-blur-xl p-6 rounded-2xl shadow-xl transition-transform hover:-translate-y-1 duration-500">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-card-foreground font-bold">Recomendaciones IA</span>
              </div>
              <span className="text-xs font-bold text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 px-2.5 py-1 rounded-full border border-emerald-500/20">+32% Eficiencia</span>
            </div>
          ...
          <div className="bg-card/60 border border-border backdrop-blur-xl p-6 rounded-2xl shadow-xl flex flex-col justify-between transition-transform hover:-translate-y-1 duration-500 delay-100">
            ...
            <div>
              <p className="text-muted-foreground text-xs font-bold mb-1.5 uppercase tracking-wider">Crecimiento</p>
              <p className="text-2xl font-black text-card-foreground">+45.2%</p>
            </div>
          </div>
          ...
          <div className="bg-card/60 border border-border backdrop-blur-xl p-6 rounded-2xl shadow-xl flex flex-col justify-between transition-transform hover:-translate-y-1 duration-500 delay-150">
            ...
            <div>
              <p className="text-muted-foreground text-xs font-bold mb-1.5 uppercase tracking-wider">Seguridad</p>
              <p className="text-2xl font-black text-card-foreground">Garantizada</p>
            </div>
          </div>
        </div>
      </div>
