...
export function CoworkingLandingView() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#090D16] text-slate-900 dark:text-slate-50 transition-colors duration-500 font-sans relative overflow-hidden selection:bg-emerald-500/30">
      
      {/* Modern Gradient Background & Ambient Lighting */}
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        {/* Top Centered Radial Emerald Glow */}
        ...
        {/* Subtle Modern Grid Pattern Overlay */}
