      ...
      <div className="relative z-10 w-full max-w-lg">
        ...
        <div className="mb-10">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-xs font-bold mb-4 shadow-sm">
            ...
            <span>Prueba Gratis, mejora tu plan cuando quieras.</span>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="col-span-2 bg-card/70 border border-border backdrop-blur-xl p-6 rounded-2xl shadow-xl transition-transform hover:-translate-y-1 duration-500">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="text-card-foreground font-bold block text-sm">Registro por WhatsApp</span>
                  <span className="text-xs text-muted-foreground">Envía fotos o notas de voz</span>
                </div>
              </div>
              <span className="text-xs font-bold text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 px-2.5 py-1 rounded-full border border-emerald-500/20">Activo</span>
            </div>
          ...
          <div className="bg-card/70 border border-border backdrop-blur-xl p-5 rounded-2xl shadow-xl flex flex-col justify-between transition-transform hover:-translate-y-1 duration-500 delay-100">
            ...
            <div>
              <p className="text-muted-foreground text-[10px] font-bold mb-1 uppercase tracking-wider">Configuración</p>
              <p className="text-xl font-black text-card-foreground">Inmediata</p>
            </div>
          </div>
          ...
          <div className="bg-card/70 border border-border backdrop-blur-xl p-5 rounded-2xl shadow-xl flex flex-col justify-between transition-transform hover:-translate-y-1 duration-500 delay-150">
            ...
            <div>
              <p className="text-muted-foreground text-[10px] font-bold mb-1 uppercase tracking-wider">Tus datos</p>
              <p className="text-xl font-black text-card-foreground">100% Seguros</p>
            </div>
          </div>
        </div>
      </div>
